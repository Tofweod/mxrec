...
#define YYJSON_GET2(root, k1) \
    yyjson_obj_get((root), (k1))

#define YYJSON_GET3(root, k1, k2) \
    yyjson_obj_get(YYJSON_GET2(root, k1), (k2))

#define YYJSON_GET4(root, k1, k2, k3) \
    yyjson_obj_get(YYJSON_GET3(root, k1, k2), (k3))

#define YYJSON_GET5(root, k1, k2, k3, k4) \
    yyjson_obj_get(YYJSON_GET4(root, k1, k2, k3), (k4))

#define YYJSON_GET6(root, k1, k2, k3, k4, k5) \
    yyjson_obj_get(YYJSON_GET5(root, k1, k2, k3, k4), (k5))

#define YYJSON_GET7(root, k1, k2, k3, k4, k5, k6) \
    yyjson_obj_get(YYJSON_GET6(root, k1, k2, k3, k4, k5), (k6))

#define YYJSON_GET8(root, k1, k2, k3, k4, k5, k6, k7) \
    yyjson_obj_get(YYJSON_GET7(root, k1, k2, k3, k4, k5, k6), (k7))
