...
#define CONFIG_FIELD_LIST                                                                                              \
	...
	CONFIG_FIELD(unsigned, lastfmapi_diffusion_level, "lastfmapi-diffusion-level", (void), "Last.fm diffusion level")\
	CONFIG_FIELD(unsigned, lastfmapi_diffusion_size,  "lastfmapi-diffusion-size",  (void), "Last.fm diffusion size") \
	...
	CONFIG_FIELD(char *,  lastfmweb_recomm_parameter, "lastfmweb-recomm-parameter", xfree, "Last.fm web recomm parameter") \
	...
	CONFIG_FIELD(uint16_t, ncm_port,                "ncm-port",                   (void),   "NCM port number")
